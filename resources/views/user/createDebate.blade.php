                ...
                <div class="col-sm-12 col-md-8 ">
                    ...
                    <div class="box-panel">
                        ...
                        <form action="" method="post" class="margin-top-40">
                            ...
                            <div class="form-group">
                                <label>Debate Detials</label>
                                <textarea cols="12" rows="12" placeholder="Post Your Debate Details Here....." id="message" name="message" class="form-control"></textarea>
                            </div>

                            <input type="hidden" name="status" value="0">

                            <button class="btn btn-primary pull-right">Publish Your Debate</button>
