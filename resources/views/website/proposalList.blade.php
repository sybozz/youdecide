                            ...
                            <div id="tab3" class="tab-pane active">
                                ...
                                <div class="listing-grid">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2 col-xs-12 hidden-xs">
                                            <a data-toggle="tooltip" data-placement="bottom" data-original-title="Martina Jaz" href="#">
                                                <img alt="" class="correct img-responsive center-block" src="{{ asset( 'uploads/profile'.'/'.$proposal->profilePicture ) }}">
                                            </a> <span class="tick2"> <i class="fa fa-check" aria-hidden="true"></i> </span>
                                        </div>
                                        <div class="col-md-7 col-sm-8  col-xs-12">
                                            <h3>{{ $proposal->title }}</h3>
                                            <div class="listing-meta"> <span><i class="fa fa-clock-o" aria-hidden="true"></i>{{ $proposal->created_at }}</span>  <span><i class="fa fa fa-eye" aria-hidden="true"></i> 750 Views</span>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-2 col-xs-12">
                                            <ul class="question-statistic">
                                        ...
                                        <div class="col-md-10 col-sm-10  col-xs-12">
                                            ...
                                            <div class="pull-right tagcloud">
                                                {{--<a href="#">Php</a>  <a href="#">recursive</a>  <a href="#">error</a>--}}
                                                {{ $proposal->tag }}
                                            </div>
                                        </div>
                                    </div>
